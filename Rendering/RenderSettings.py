...
class RenderSettings:
    ...
    def __init__(self, vials_per_row = 6, margin_size = 0.025, vial_spacing = 0.7, row_spacing = 0.5, vial_rect = core.Rectangle2(core.Vector2(0, 0.15), core.Vector2(1, 0.85)), ui_rect = core.Rectangle2(core.Vector2(0, 0), core.Vector2(1, 0.15)), clear_color=core.Color(0, 0, 0), vial_model=VialModel()):
