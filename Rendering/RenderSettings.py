...
class RenderSettings:
    ...
    def __init__(self, vial_per_row = 6, margin_size = 0.05, vial_spacing = 0.6, row_spacing = 0.5, ui_rect = core.Rectangle2(Vector2(0, 0), Vector2(1, 0.15)), clear_color=core.Color(0, 0, 0)):
